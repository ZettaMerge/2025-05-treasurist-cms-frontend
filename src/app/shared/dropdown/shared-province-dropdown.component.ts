...
@Component({
  selector: 'shared-province-dropdown',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SharedProvinceDropdownComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SharedProvinceDropdownComponent extends BaseDropdown<any> {
  ...
  protected apiOptionListGet$() {
    ...
    return this.masterAddressService.dropdownProvinceGet$();
