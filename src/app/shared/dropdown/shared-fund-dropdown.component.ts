  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SharedFundDropdownComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SharedFundDropdownComponent extends BaseDropdown<FundDropdownDTO> {
  ...
  protected apiOptionListGet$() {
    ...
    return this.fundService.fundDropdownGet$(isObject ? this.amc?.amcCode : this.amc, this.fcnAccountId, this.isActive ? this.isActive : undefined);
  }
}
