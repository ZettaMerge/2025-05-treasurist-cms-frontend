...
@Component({
  selector: 'shared-nationality-dropdown',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SharedNationalityDropdownComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SharedNationalityDropdownComponent extends BaseDropdown<DropdownDTO> {
  ...
  protected apiOptionListGet$() {
    return this.dropdownService.dropdownNationalityGet$();
  }
}
