...
@Component({
  selector: 'shared-file-categories-dropdown',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SharedFileCategoriesDropdownComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SharedFileCategoriesDropdownComponent extends BaseDropdown<any> {
  ...
  protected apiOptionListGet$() {
    return this.dropdownService.dropdownFileCategoryGet$();
  }
}
