...
import {of} from 'rxjs';
import {AssetDropdownDTO, BankBranchDTO, BankDTO, DropdownDTO} from '@model';
import {AssetService, DropdownService, MasterBankService} from '@api';

@Component({
  selector: 'shared-bank-branch-dropdown',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SharedBankBranchDropdownComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SharedBankBranchDropdownComponent extends BaseDropdown<BankBranchDTO> {

  @Input() bankCode;

  inputChanges = ['bankCode'];
  ...
  protected apiOptionListGet$() {
    ...
    return this.dropdownService.dropdownBankBranchGet$(this.bankCode);
  }
}
