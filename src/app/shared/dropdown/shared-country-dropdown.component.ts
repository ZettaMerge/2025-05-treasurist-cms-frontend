...
@Component({
  selector: 'shared-country-dropdown',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SharedCountryDropdownComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SharedCountryDropdownComponent extends BaseDropdown<DropdownDTO> {
  ...
  protected apiOptionListGet$() {
    return this.dropdownService.dropdownCountryGet$();
  }
}
