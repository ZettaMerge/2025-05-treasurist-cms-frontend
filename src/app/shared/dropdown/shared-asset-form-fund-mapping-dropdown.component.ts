...
@Component({
  selector: 'shared-asset-form-fund-mapping-dropdown',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SharedAssetFormFundMappingDropdownComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SharedAssetFormFundMappingDropdownComponent extends BaseDropdown<AssetDropdownDTO> {
