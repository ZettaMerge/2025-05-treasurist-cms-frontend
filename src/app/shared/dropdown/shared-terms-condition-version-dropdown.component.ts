...
@Component({
  selector: 'shared-terms-condition-version-dropdown',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SharedTermsConditionVersionDropdownComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SharedTermsConditionVersionDropdownComponent extends BaseDropdown<ContentDTO> {
  ...
  constructor(
    ...
    protected termAndConditionService: ContentService,
  ) {
    super(cdr);
  }
  ...
  protected apiOptionListGet$() {
    return this.termAndConditionService.contentDropDownGet$(this.contentType);
  }
}
