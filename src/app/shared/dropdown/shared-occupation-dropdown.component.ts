...
@Component({
  selector: 'shared-occupation-dropdown',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SharedOccupationDropdownComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SharedOccupationDropdownComponent extends BaseDropdown<DropdownDTO> {
  ...
  protected apiOptionListGet$() {
    return this.dropdownService.dropdownOccupationGet$();
  }
}
