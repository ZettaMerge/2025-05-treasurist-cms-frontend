...
@Component({
  selector: 'shared-business-dropdown',
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SharedBusinessDropdownComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SharedBusinessDropdownComponent extends BaseDropdown<DropdownDTO> {
  ...
  protected apiOptionListGet$() {
    return this.dropdownService.dropdownBusinessGet$();
  }
}
