...
@Component({
  selector: 'fe-dca',
  templateUrl: './fe-dca.component.html',
  styleUrls: ['./fe-dca.component.scss']
})
export class FeDcaComponent extends BaseFeatureGridComponent<PropType, any> implements OnInit {
  ...
  @ViewChild('typeDCATpl', {static: true}) typeDCATpl: TemplateRef<any>;
  ...
  detailInfo(item) {
    const url = `agent/customer-service/dca/${item.id}`;
