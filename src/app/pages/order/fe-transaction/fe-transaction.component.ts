...
@Component({
  selector: 'fe-transaction',
  templateUrl: './fe-transaction.component.html',
  styleUrls: ['./fe-transaction.component.scss']
})
export class FeTransactionComponent extends BaseFeatureGridComponent<any> implements OnInit, OnDestroy, OnChanges {
