...
@Component({
  selector: 'fe-form-account-form-mail-address',
  templateUrl: './fe-form-account-form-mail-address.component.html',
  styleUrls: ['./fe-form-account-form-mail-address.component.scss']
})
export class FeFormAccountFormMailAddressComponent implements OnInit {
